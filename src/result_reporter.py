...
import persistence.sqlite_client
from config import Config
from persistence.mongo_client import config
from persistence.storage import Storage
from persistence.sqlite_client import create_sqlite_database, write_token_batch
...
class Reporter:
    ...
    def generate_report(self):
        ...
        progress_bar.close()
        logging.info(f"Finished report generation file={persistence.sqlite_client.db_name}")
